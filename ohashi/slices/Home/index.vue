<template>
  <Bounded as="section" class="relative">
    ...
    <div id="entry" class="md:flex opacity-30 transition-all md:mt-16 mt-4 gap-6 justify-center"><div class="md:w-[calc(32vw-0.75rem)]"><PrismicImage :field="slice.primary.image1" class="w-full" /><PrismicRichText :field="slice.primary.label1"  class="hidden pr-[5px] md:block text-right text-xl italic font-kingscarlos tracking-[-0.015em] text-[#969696]"/></div>

    <div class="md:hidden text-center max-w-xl m-auto text-2xl md:text-4xl tracking-[-0.02em] font-bigcarlos text-[#725741] mt-7 leading-[1.875rem]">Authentic Japanese handmade ramen noodles by chef <span class="underline">Ohashi</span></div>
    ...
    <div class="hidden md:block text-center max-w-xl m-auto text-2xl md:text-4xl tracking-[-0.02em] font-bigcarlos text-[#725741] mt-14 leading-[1.875rem]">Authentic Japanese handmade ramen noodles by chef <span class="underline">Ohashi</span></div>
